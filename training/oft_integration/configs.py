...
OXE_DATASET_CONFIGS = {
    ...
    # Poultry-VLA blue chick (mirrors libero_object: image + wrist_image + 8d state).
    "blue_chick_thermal": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", "gripper_state"],
    ...
    # DAgger r4: release-focused corrections (separate dataset for oversampling).
    "blue_chick_dagger_r4": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", "gripper_state"],
        "state_encoding": StateEncoding.POS_EULER,
    ...
    # DAgger round1: v3 demos + on-policy expert corrections (2a-format obs).
    "blue_chick_dagger": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", "gripper_state"],
    ...
    # Affordance experiment: 2a-format (agentview+wrist RGB) with enlarged grasp affordance.
    "blue_chick_thermal_aff": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", "gripper_state"],
        "state_encoding": StateEncoding.POS_EULER,
    ...
    # Stage 2b: wrist_image slot carries COLORIZED WRIST DEPTH (same schema, depth-as-image).
    "blue_chick_thermal_wd": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", "gripper_state"],
        "state_encoding": StateEncoding.POS_EULER,
