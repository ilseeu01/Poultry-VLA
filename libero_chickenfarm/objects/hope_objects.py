...
@register_object
class Chicken(HopeBaseObject):
    def __init__(self, name="chicken", obj_name="chicken"):
        super().__init__(name, obj_name)
        # 닭 mesh는 Z가 높이라 회전 불필요
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"


@register_object
class ChickCrouching(HopeBaseObject):
    def __init__(self, name="chick_crouching", obj_name="chick_crouching"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"
...
@register_object
class ChickLookingLeft(HopeBaseObject):
    def __init__(self, name="chick_looking_left", obj_name="chick_looking_left"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"
...
@register_object
class DeadChick(HopeBaseObject):
    def __init__(self, name="dead_chick", obj_name="dead_chick"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"


# IR 그라데이션 살아있는 병아리 (Jet 팔레트 warm 쪽)
@register_object
class ChickWarmGreen(HopeBaseObject):
    def __init__(self, name="chick_warm_green", obj_name="chick_warm_green"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"
...
@register_object
class ChickWarmYellow(HopeBaseObject):
    def __init__(self, name="chick_warm_yellow", obj_name="chick_warm_yellow"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"
...
@register_object
class ChickWarmOrange(HopeBaseObject):
    def __init__(self, name="chick_warm_orange", obj_name="chick_warm_orange"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"
...
@register_object
class ChickWarmRed(HopeBaseObject):
    def __init__(self, name="chick_warm_red", obj_name="chick_warm_red"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"
...
@register_object
class StrawPiece(HopeBaseObject):
    def __init__(self, name="straw_piece", obj_name="straw_piece"):
        super().__init__(name, obj_name)
        # 짚은 어느 방향으로든 누워있어도 OK
        self.rotation = (0.0, 6.283)
        self.rotation_axis = "z"


@register_object
class FeedPellet(HopeBaseObject):
    def __init__(self, name="feed_pellet", obj_name="feed_pellet"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 0.0)
        self.rotation_axis = "z"
...
@register_object
class ManurePile(HopeBaseObject):
    def __init__(self, name="manure_pile", obj_name="manure_pile"):
        super().__init__(name, obj_name)
        self.rotation = (0.0, 6.283)
        self.rotation_axis = "z"
